...
import by.epam.cafe.dao.CompetitionDAO;
...
import static by.epam.cafe.constant.SQLRequestConstant.*;
...
public class CompetitionDAOImpl extends CompetitionDAO {
    ...
    public boolean delete(int id) throws DAOException {
        ...
        try (PreparedStatement statement = connection.prepareStatement(DELETE_COMPETITION_BY_ID)) {
            statement.setInt(1, id);
