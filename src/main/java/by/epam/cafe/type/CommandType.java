...
import by.epam.cafe.command.bet.CreateBetCommand;
...
import by.epam.cafe.command.competition.*;
import by.epam.cafe.command.competitiontype.CreateCompetitionTypeCommand;
import by.epam.cafe.command.competitiontype.DeleteCompetitionTypeCommand;
import by.epam.cafe.command.competitiontype.OpenCompetitionTypeCommand;
import by.epam.cafe.command.competitiontype.UpdateCompetitionTypeCommand;
import by.epam.cafe.command.kindofsport.CreateKindOfSportCommand;
import by.epam.cafe.command.kindofsport.DeleteKindOfSportCommand;
import by.epam.cafe.command.kindofsport.OpenKindOfSportCommand;
import by.epam.cafe.command.kindofsport.UpdateKindOfSportCommand;
import by.epam.cafe.command.news.*;
import by.epam.cafe.command.team.*;
