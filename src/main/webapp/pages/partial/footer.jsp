...
<footer class="footer w3-container w3-theme-d3 w3-padding-16 w3-display-container">
    ...
    <div class="w3-display-right">
            <input type="image" src="${pageContext.request.contextPath}/image/language/ru.png" name="locale" value="RU" onclick="changeLanguage(this)">
            <input type="image" src="${pageContext.request.contextPath}/image/language/en.png" name="locale" value="EN" onclick="changeLanguage(this)">
    </div>
</footer>
