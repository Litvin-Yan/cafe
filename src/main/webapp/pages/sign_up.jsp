...
<div class="w3-row">
    ...
    <div class="w3-third">
        ...
        <form class="w3-container w3-card-2" name="form" action="${pageContext.request.contextPath}/generalController" method="post">
            ...
            <span class="w3-text-red" id="wrongName"><c:out value="${txtWrongName}"/></span>
            <span class="w3-text-red" id="emptyName"><c:out value="${txtEmptyFeild}"/></span>
            ...
            <br>
            <p><input class="w3-button w3-black w3-text-amber" style="margin-bottom: 8px" type="submit" id="submit" value="${signUp}"></p>
        </form>
    </div>
    <div class="w3-third">
        <div class="w3-container"></div>
